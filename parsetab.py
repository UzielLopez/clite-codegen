...
_lr_productions = [
  ...
  ('Functions -> Function Functions','Functions',2,'p_Functions','analisis.py',62),
  ('Functions -> empty','Functions',1,'p_Functions','analisis.py',63),
  ('Function -> Type ID ( ParameterList ) { Declarations Statements }','Function',9,'p_Function','analisis.py',70),
  ('Function -> Type ID ( ) { Declarations Statements }','Function',8,'p_Function','analisis.py',71),
  ('ParameterList -> Parameter','ParameterList',1,'p_ParameterList','analisis.py',80),
  ('ParameterList -> ParameterList , Parameter','ParameterList',3,'p_ParameterList','analisis.py',81),
  ('Parameter -> Type ID','Parameter',2,'p_Parameter','analisis.py',91),
  ('empty -> <empty>','empty',0,'p_empty','analisis.py',104),
  ('Declarations -> Declaration Declarations','Declarations',2,'p_Declarations','analisis.py',110),
  ('Declarations -> empty','Declarations',1,'p_Declarations','analisis.py',111),
  ('Declaration -> Type ID ;','Declaration',3,'p_Declaration','analisis.py',118),
  ('Type -> INT','Type',1,'p_Type','analisis.py',124),
  ('Type -> BOOL','Type',1,'p_Type','analisis.py',125),
  ('Type -> FLOAT','Type',1,'p_Type','analisis.py',126),
  ('Type -> CHAR','Type',1,'p_Type','analisis.py',127),
  ('Statements -> Statement Statements','Statements',2,'p_Statements','analisis.py',133),
  ('Statements -> empty','Statements',1,'p_Statements','analisis.py',134),
  ('Statement -> ;','Statement',1,'p_Statement','analisis.py',142),
  ('Statement -> Expression ;','Statement',2,'p_Statement','analisis.py',143),
  ('Statement -> Block','Statement',1,'p_Statement','analisis.py',144),
  ('Statement -> Assignment','Statement',1,'p_Statement','analisis.py',145),
  ('Statement -> IfStatement','Statement',1,'p_Statement','analisis.py',146),
  ('Statement -> ForStatement','Statement',1,'p_Statement','analisis.py',147),
  ('Statement -> WhileStatement','Statement',1,'p_Statement','analisis.py',148),
  ('Statement -> ReturnStatement','Statement',1,'p_Statement','analisis.py',149),
  ('Block -> { Statements }','Block',3,'p_Block','analisis.py',155),
  ('Assignment -> ID = Expression ;','Assignment',4,'p_Assignment','analisis.py',161),
  ('IfStatement -> IF ( Expression ) Statement','IfStatement',5,'p_IfStatement','analisis.py',167),
  ('IfStatement -> IF ( Expression ) Statement ELSE Statement','IfStatement',7,'p_IfStatement','analisis.py',168),
  ('ForStatement -> FOR ( ID = Expression ; Expression ; ID = Expression ) Statement','ForStatement',13,'p_ForStatement','analisis.py',177),
  ...
  ('UnaryOp -> !','UnaryOp',1,'p_UnaryOp','analisis.py',334),
  ('Primary -> FLOATLIT','Primary',1,'p_Primary_FloatLit','analisis.py',339),
  ('Primary -> INTLIT','Primary',1,'p_Primary_IntLit','analisis.py',343),
  ('Primary -> ID','Primary',1,'p_Primary_Id','analisis.py',347),
